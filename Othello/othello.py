...
def play_game(black_strategy, white_strategy):
#
    game = []
    board = initial_board()
    player = BLACK
    ...
    while player is not None:
        ...
        game.append(list(board))
    if score(BLACK, board) > 0: return (game, 1)
    else: return (game, -1)
...
def random_weighted_score():
    weights = [random.randint(60, 100) for i in range(100)]
