...
def plot_images(images, cls_true, cls_pred=None):
    ...
    for i, ax in enumerate(axes.flat):
        # Plot image.
        ax.imshow(images[i].reshape(board_shape), cmap='binary')
...
def plot_image(image):
    plt.imshow(image.reshape(board_shape),
...
print(predict_image(data.test.images[7]))
plot_image(image1)
image2 = data.test.images[8]
print(predict_image(data.test.images[8]))
plot_image(image2)
